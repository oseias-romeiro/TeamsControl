...
class CustomUser(AbstractUser):
    ...
    nome_completo = models.CharField('Full name', max_length=100)
    interesse = models.CharField('Interested Area', max_length=100)
    linkedin = models.CharField('Linkedin', max_length=100)
    is_staff = models.BooleanField('Member', default=True)

    USERNAME_FIELD = 'email'
    REQUIRED_FIELDS = ['username', 'nome_completo', 'interesse']
